...
public class Parqueo {
    ...
    //metodos para el recepcionista al ingresar a cada opcion del menu principal:
    public boolean asignarEspacioParq() {

        String piso = JOptionPane.showInputDialog("Digite el piso en el que desea ocupar(S1,S2,S3): ");
        if (piso.equalsIgnoreCase("S1") || piso.equalsIgnoreCase("S2") || piso.equalsIgnoreCase("S3")) {
            ...
            JOptionPane.showMessageDialog(null, "¡Piso elegido inexistente!");
        }
    ...
    public boolean liberarEspacioP() {
        ...
        if (pisoLiberar.equalsIgnoreCase("S1") || pisoLiberar.equalsIgnoreCase("S2") || pisoLiberar.equalsIgnoreCase("S3")) {
            ...
            switch (pisoLiberar) {
                case "S1":
                    ...
                    } else if (S1[filaVaciar][columnaVaciar] == "[O]") {
                ...
                case "S2":
                    if (S2[filaVaciar][columnaVaciar] == "[P]") {
                        ...
                        JOptionPane.showMessageDialog(null, "¡Espacio liberado exitosamente!");
                    } else if (S2[filaVaciar][columnaVaciar] == "[O]") {
                        JOptionPane.showMessageDialog(null, "¡El espacio que elegiste ya estaba liberado!");
                ...
                case "S3":
                    if (S3[filaVaciar][columnaVaciar] == "[P]") {
                        ...
                        JOptionPane.showMessageDialog(null, "¡Espacio liberado exitosamente!");
                    } else if (S3[filaVaciar][columnaVaciar] == "[O]") {
                        JOptionPane.showMessageDialog(null, "¡El espacio que elegiste ya estaba liberado!");
