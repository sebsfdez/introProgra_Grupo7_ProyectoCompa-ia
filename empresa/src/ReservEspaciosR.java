...
public class ReservEspaciosR {
    ...
    public boolean reservaMesaPingPong() {
        JOptionPane.showMessageDialog(null, "Reserva de mesa de ping pong realizada");
        return true;
    }

    public boolean reservaMesaBillar() {
        JOptionPane.showMessageDialog(null, "Reserva de mesa de billar realizada");
        return true;
    }

    public boolean reservaCanchaFutboll() {
        JOptionPane.showMessageDialog(null, "Reserva de cancha de futbol realizada");
        return true;
    }

    public boolean reservaCanchaBasket() {
        JOptionPane.showMessageDialog(null, "Reserva de cancha de basket realizada");
        return true;
    }

    public boolean reservaCanchaTenis() {
        JOptionPane.showMessageDialog(null, "Reserva de cancha de tenis realizada");
        return true;
    }
